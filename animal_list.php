  ...
  <body>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end">
          <div class="col-md-9 ftco-animate pb-5">
          	<p class="breadcrumbs mb-2"><span class="mr-2"><a href="index.php">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Animal List <i class="ion-ios-arrow-forward"></i></span></p>
            <h1 class="mb-0 bread">Animals</h1>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="ftco-section bg-light">
      <div class="container">
		...
		<?php 
			$sql = (mysqli_query($con, "SELECT * FROM animal_gallery WHERE animal_gallery.is_deleted !='1' ORDER BY animal_gallery_no DESC "));
			while($row=mysqli_fetch_assoc($sql)){
				$date=$row['created_on'];
          ...
          <div class="col-md-6 col-lg-3 ftco-animate">
						<div class="staff">
							<div class="img-wrap d-flex align-items-stretch">
								<div class="img align-self-stretch" style="background-image: url(admin/soft/upload/<?php echo $row['gallery_pic']; ?>);"></div>
							</div>
							<div class="text pt-3 px-3 pb-4 text-center">
								<h3><?php echo $row['image_title']; ?></h3>
								<h5><?php echo $row['price']; ?></h5>
								<span class="position mb-2"><?php echo $row['animal_tag']; ?></span>
								<div class="faded">
									<p><?php echo mb_substr($description,0,100); ?><a href="view_animal.php?image_title:=<?php echo $row['image_title'];?>" style="color:red;" class="btn btn-primary">See More</a>
								</div>
							</div>
						</div>
					</div>
