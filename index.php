...
<html lang="en">
  ...
  <body>
		...
		?>
    <!-- END nav -->
    <div class="hero-wrap js-fullheight" style="background-image: url('images/q.jpg');" data-stellar-background-ratio="0.5">
      <div class="overlay"></div>
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-11 ftco-animate text-center">
          	<h1 class="mb-4" style="color: Green">Animal Trading House</h1>
          ...
          <div class="col-md-4 d-flex align-self-stretch px-4 ftco-animate">
            <div class="d-block services active text-center">
              ...
              <div class="media-body">
                ...
                <p>Dog walking is the act of a person walking with a dog, typically from the dog's residence and then returning. Leashes are commonly used for this. Both owners and pets receive many benefits, including exercise and companionship.p>
          ...
          <div class="col-md-4 d-flex align-self-stretch px-4 ftco-animate">
            <div class="d-block services text-center">
              ...
              <div class="media-body">
                ...
                <p>pet daycare works a lot like daycare for children. You drop your animal off in the morning on the way to work. While you are gone, your pet will get plenty of attention. Your pet's day will be filled with activities based on the curriculum set out by the daycare facility on your pet's specific needs and temperament.</p>
                <a href="#" class="btn-custom d-flex align-items-center justify-content-center"><span class="fa fa-chevron-right"></span><i class="sr-only">Read more</i></a>
              </div>
            </div>    
          </div>
          <div class="col-md-4 d-flex align-self-stretch px-4 ftco-animate">
            <div class="d-block services text-center">
              ...
              <div class="media-body">
                ...
                <p>A professional grooming session typically consists of the Animal being brushed, bathed and dried, as well as trimmed or clipped. The groomer brushes or combs out mats before the bath, making it easier to lather the animal with shampoo. They clean the animal's ears to remove buildup and to check for signs of infection..</p>
                <a href="#" class="btn-custom d-flex align-items-center justify-content-center"><span class="fa fa-chevron-right"></span><i class="sr-only">Read more</i></a>
              </div>
            </div>      
          </div>
            ...
            <div class="carousel-testimony owl-carousel ftco-owl">
              <div class="item">
                <div class="testimony-wrap py-4">
                  ...
                  <div class="text">
                    <p class="mb-4">Informative”</p>
                    <div class="d-flex align-items-center">
                    	<div class="user-img" style="background-image: url(images/pam.jpg)"></div>
                    	<div class="pl-3">
		                    <p class="name">Pam Moore</p>
              ...
              <div class="item">
                <div class="testimony-wrap py-4">
                	<div class="icon d-flex align-items-center justify-content-center"><span class="fa fa-quote-left"></span></div>
                  <div class="text">
                    <p class="mb-4">    “looks Good.”        </p>
                    <div class="d-flex align-items-center">
                    	<div class="user-img" style="background-image: url(images/fish.jpg)"></div>
                    	<div class="pl-3">
		                    <p class="name">Tom Fishburne</p>
		                    <span class="position">.</span>
		                  </div>
	                  </div>
                  </div>
              ...
              <div class="item">
                <div class="testimony-wrap py-4">
                	<div class="icon d-flex align-items-center justify-content-center"><span class="fa fa-quote-left"></span></div>
                  <div class="text">
                    <p class="mb-4">“It helps in times of crisis.</p>
                    <div class="d-flex align-items-center">
                    	<div class="user-img" style="background-image: url(images/ab.jpg)"></div>
                    	<div class="pl-3">
		                    <p class="name">John Sinha</p>
		                    <span class="position"></span>
		                  </div>
	                  </div>
                  </div>
                ...
                <div class="testimony-wrap py-4">
                  ...
                  <div class="text">
                    ...
                    <div class="d-flex align-items-center">
                    	...
                    	<div class="pl-3">
		                    <p class="name">Mr. Ibraham Khan </p>
		                    <span class="position"></span>
		                  </div>
	                  </div>
                  </div>
              ...
              <div class="item">
                <div class="testimony-wrap py-4">
                	<div class="icon d-flex align-items-center justify-content-center"><span class="fa fa-quote-left"></span></div>
                  <div class="text">
                    <p class="mb-4">Helpfull
					</p>
                    <div class="d-flex align-items-center">
                    	<div class="user-img" style="background-image: url(images/person_3.jpg)"></div>
                    	<div class="pl-3">
		                    <p class="name">R K Rahman</p>
		                    <span class="position"></span>
		                  </div>
	                  </div>
                  </div>
