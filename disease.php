      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end">
          <div class="col-md-9 ftco-animate pb-5">
          	<p class="breadcrumbs mb-2"><span class="mr-2"><a href="index.php">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Diseases<i class="ion-ios-arrow-forward"></i></span></p>
            <h1 class="mb-0 bread">Disease LIsts</h1>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="ftco-section bg-light">
    	<div class="container">
          ...
          <div class="col-md-7 heading-section text-center ftco-animate">
            <h2>Diseases are here with Solution</h2>
          </div>
        </div>
    		<div class="row">
			<?php 
						
						$sql = (mysqli_query($con,"SELECT * FROM animal_disease LEFT JOIN add_animal ON add_animal.animal_no=animal_disease.animal_no WHERE animal_disease.is_deleted != '1' ORDER BY animal_disease_no DESC "));
						while($row = mysqli_fetch_assoc($sql)){
	          ...
	          <div class="block-7">
	            <div class="text-center p-4">
	            	Disease Name:<span class="excerpt"> <?php echo $row['disease_name']; ?></span>  <?php echo $row['animal_name']; ?>
	            	<a href="view_disease.php?disease_name:=<?php echo $row['disease_name'];?>" class="btn btn-primary">See More</a>
	            </div>
	          </div>
	        </div>
			<?php } ?>
    	...
    	<div class="container">
    		<div class="row d-md-flex justify-content-end">
    			<div class="col-md-12 col-lg-6 half p-3 py-5 pl-lg-5 ftco-animate">
    				...
    				<form method="POST" action="consulphp.php" class="appointment" >
    					<div class="row">
    						<div class="col-md-12">
	                      ...
	                      <select name="services" id="" class="form-control">
	                        ...
	                        <option value="Animal Spa">Animal Spa</option>
	                        <option value="Animal Grooming">Animal Grooming</option>
	                        <option value="Animal Daycare">Animal Daycare</option>
	                      </select>
	                    </div>
			              </div>
			    				</div>
								...
								<div class="col-md-6">
									<div class="form-group">
			              <input type="text" name="consul_name" class="form-control" placeholder="Your Name">
			            </div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
			              <input type="email" class="form-control" name="consul_email" placeholder="Email Address">
			            </div>
								</div>
								
								<div class="col-md-6">
									<div class="form-group">
			              <input type="date" class="form-control" name="consul_date" placeholder="">
			            </div>
								</div>
			            		...
			            		<input type="text" name="consul_time" class="form-control appointment_time" placeholder="Time">
		            		</div>
			    				</div>
								</div>
								<div class="col-md-12">
									<div class="form-group">
			              <textarea name="consul_message" id="" cols="30" rows="7" class="form-control" placeholder="Message"></textarea>
			            </div>
								</div>
								<div class="col-md-12">
